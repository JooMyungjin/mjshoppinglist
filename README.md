...
쿠팡, 네이버쇼핑, 11번가, 알리익스프레스 구매 내역을 자동으로 수집하고 한 곳에서 관리하는 크롬 확장프로그램입니다.
...
1. 쿠팡 / 네이버 / 11번가 / 알리익스프레스 주문 내역 페이지를 엽니다
2. 확장프로그램 아이콘 클릭
...
> - 11번가: 마이11번가 > 주문배송 내역
> - 알리익스프레스: aliexpress.com/p/order/index.html
...
| 🤖 기타 항목 자동 분류 | AI로 `기타` 항목만 분류 |
| 🔄 전체 카테고리 초기화 | 수동 편집 제외, categories.js 기준으로 전체 재분류 |
